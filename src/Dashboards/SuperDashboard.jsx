    ...
    return (
        <div className="fyp-dashboard" onClick={closeSidebar}>
            ...
            <div className={`sidebar ${isSidebarOpen ? 'open' : ''}`} onClick={(e) => e.stopPropagation()}>
                <div>
                    <p className="Logoword font-BebasNeueSemiExpBold text-3xl">Supervisor Dashboard</p>
                </div>
                <ul className="space-y-1">
                    ...
                    <li className={`${selectedComponent === 'GroupList' ? 'bg-[#0056b3]' : 'bg-transparent'}`} onClick={() => { setSelectedComponent("GroupList"); setIsSidebarOpen(!isSidebarOpen); }}>Groups</li>
                    ...
                    <li className={`${selectedComponent === 'ProejectRecords' ? 'bg-[#0056b3]' : 'bg-transparent'}`} onClick={() => { setSelectedComponent("ProejectRecords"); setIsSidebarOpen(!isSidebarOpen); }}>Past Projects</li>
